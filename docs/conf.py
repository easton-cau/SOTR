...
project = 'AdelaiDet'
copyright = '2020, Hao Chen, Zhi Tian'
author = 'Hao Chen, Zhi Tian'

# The short X.Y version
version = adet.__version__
...
intersphinx_mapping = {
    ...
    "detectron2": ("https://detectron2.readthedocs.io/", None),
}
# -------------------------
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', "build", "README_no.md"]
...
latex_documents = [
    (master_doc, "adet.tex", "AdelaiDet Documentation", "AdelaiDet contributors", "manual")
]
...
man_pages = [(master_doc, "adet", "AdelaiDet Documentation", [author], 1)]
...
def url_resolver(url):
    if ".html" not in url:
        url = url.replace("../", "")
        return "https://github.com/aim-uofa/adet/blob/master/" + url
    else:
        if DEPLOY:
            return "http://adet.readthedocs.io/" + url
        else:
            return "/" + url
